...
import time, openai, os, random, base64
import pandas as pd
import numpy as np
...
list_api = [
    "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",
    "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",
    "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",
    "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",
    "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"
]
...
if selected == 'Theory':
    ...
    # horizontal Menu
    selected2 = option_menu(None, ['Permutation', 'Combination', 'AingBotz:sparkles:'],
    ...
    if selected2 == 'Permutation':
        ...
        iterable = st.text_input(label="Masukkan Iterable dipisahkan oleh spasi")
